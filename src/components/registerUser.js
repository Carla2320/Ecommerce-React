            ...
            <section>
              ...
              <div class="form-group">
                <input
                  ...
                  onChange={handleInputChange}
                  id="direccion_secundaria"
                  aria-describedby="direccion_secundaria"
                />
              </div>
              <div class="form-group">
                <label for="provincia" id="provi">
                  Escoge tu provincia
                </label>
                <select
                  id="provincia"
              ...
              <div class="form-group">
                <label for="inputState" id="multi">
                  Escoge un Multiplo
                </label>
                <option hidden selected>
                  Selecciona una Multiplo
                </option>
                <select
                  id="multipo"
                  class="form-control"
              ...
              <div>
                <button id="boton" type="submit" onClick={handleSubmit}>
                  Registrarse
                </button>
              </div>
            </section>
